...
/** The Queue class is a generic queue implemented by a doubly linked list,
 * and it includes a constructor, enqueue, dequeue, peek, empty, toString, 
 * copy, append and equals.
 * @param <E> data type of queue elements 
 * @author Mike McKee
*/
public class Queue<E> {
    ...
    public E peek() {
        ...
        if (head == null)
            throw new IllegalArgumentException("You can't peek an empty queue"
                                               + ", Silly!");
        else {
            queueTop = head.data;
            return queueTop;
